...
<div  style="width:90%; background:#fff; margin-top:1%">
	<div class="alert alert-success">Circunferencial - Diagnostico <a href="../../<?php echo "paciente/".$id;?>" style="margin-left:52%;" class="btn btn-primary">Realizar nuevo diagnostico</a> </div>
    ...
    <div class="col-lg-6">
     ...
     <div class="form-group">
         ...
         <div class="form-group">
           <?php if($mensaje2=='Sobrepeso riesgoso'):?>
            <div class="alert alert-warning">
            <b>Diagnostico</b>
            <br/><br/>
