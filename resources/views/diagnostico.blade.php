...
.navbar2-collapse .navbar2-nav.navbar2-right:last-child {
	...
	<div class="container" style="padding:0px; margin-top:-1%; margin-left:10%;">
    ...
    <div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
      <ul class="nav navbar-nav" style="width:100%;">       
        ...
        <li style="width:100%;" class="dropdown">
          ...
          <ul class="dropdown-menu forAnimate" role="menu">
            <li><a href="#">· Cribaje</a></li>
            <li><a href="#">· Evaluacion alimentaria</a></li>
            <li><a href="#">· Evaluacion global</a></li>
          </ul>
        </li>                    
...
<div style=" float:right">CUESTIONARIO</div>
	</div>
@stop