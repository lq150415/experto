...
<div  style="width:100%; background:#fff;float:right; margin-top:1%">
	<div class="alert alert-success">Circunferencial - Antropometrico <a style="margin-left:55%;" href="../<?php echo $id;?>" class="btn btn-primary">Realizar nuevo diagnostico</a></div>
	<div class="alert panel panel-success cuerpo" style="background:#fff; margin-top:-2.7%">
		<form class="form-horizontal" action="diagnosticarcircunferencial" method="POST">
    ...
    <div class="col-lg-7">
      <input type="number" step="any" name="estaturaactual" value="" class="form-control" id=""
    ...
    <div class="col-lg-7">
      <input type="number" step="any" name="pesoactual" value=""  class="form-control" id=""
  ...
  <div class="form-group">
    ...
    <div class="col-lg-7">
      <input type="number" step="any" name="CB" value=""  class="form-control" id=""
             placeholder="Digite la circunferencia del brazo">
    </div>
  </div>  
  <div class="form-group">
    <label for="ejemplo_email_3" class="col-lg-4 control-label">Circunferencia de la cintura</label>
    <div class="col-lg-7">
      <input type="number" step="any" name="cc" value=""  class="form-control" id=""
             placeholder="Digite la circunferencia de la cintura">
    </div>
  </div>  
  <div class="form-group">
    <label for="ejemplo_email_3" class="col-lg-4 control-label">Circunferencia de la cadera</label>
    <div class="col-lg-7">
      <input type="number" step="any" name="ccc" value=""  class="form-control" id=""
             placeholder="Digite la circunferencia de la cadera">
    </div>
  </div>  
